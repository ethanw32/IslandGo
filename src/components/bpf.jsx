...
export default function Bpf() {
  ...
  return (
    ...
    <div className='flex my-5'>
        ...
        <div className='float-right my-5'><h1 className='font-bold text-2xl mb-2.5'>Discover the Enchanted Forests of Grenada</h1> <p className='max-sm:text-sm w-[600px]' >Immerse yourself in the natural beauty of Grenada's pristine rainforests on this guided eco-tour. This adventure takes you deep into the heart of the island's lush greenery, where you'll discover vibrant flora, exotic wildlife, and hidden waterfalls. Perfect for nature lovers and adventure seekers, this tour offers a mix of hiking, sightseeing, and cultural insights.</p>
        <h2 className='my-2.5 font-bold text-xl'>Spots</h2>
