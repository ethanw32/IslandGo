...
const BusinessSetup = () => {
  ...
  return (
    <div className="min-h-screen bg-dark flex items-center justify-center p-4">
      <div className="bg-dark text-dark p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full px-3 py-2 border bg-dark text-dark rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
              required
            />
          </div>
          <div>
          ...
          <div>
            <label className="block text-sm font-medium text-dark">Type of Business</label>
            <select
              value={businessType}
          ...
          <div>
            <label className="block text-sm font-medium text-dark">Business Description</label>
            <textarea
          ...
          <div>
            <label className="block text-sm font-medium text-dark">Business Profile Picture</label>
            <input
              type="file"
              accept="image/*"
              onChange={(e) => setBusinessImage(e.target.files[0])}
              className="mt-1 block w-full text-sm text-dark file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100"
              required
            />
          </div>
          <div>
            <button
              type="submit"
              disabled={isLoading}
              className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-dark bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
